export const redirectUri = `${process.env.NEXT_PUBLIC_BASE_URL}/login/oauth/kakao/callback`
...
export const NAVER_REDIRECT_URI = `${process.env.NEXT_PUBLIC_BASE_URL}/login/oauth/naver/callback` // Callback URL
...
export const GOOGLE_REDIRECT_URI = `${process.env.NEXT_PUBLIC_BASE_URL}/login/oauth/google/callback`
